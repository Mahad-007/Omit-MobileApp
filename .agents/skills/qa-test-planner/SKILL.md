...
> **Note:** Priority (P0–P3) indicates business urgency — how soon a fix is needed (P0 = immediate, blocks release). Severity (Critical–Low) indicates technical impact — how badly the defect affects the system. A bug can be high severity but low priority (e.g., crash in a rarely-used feature) or vice versa.
...
| **Medium**   | Feature partial, workaround exists  | Filter missing one option   |
| **Low**      | Cosmetic, rare edge cases           | Typo, minor alignment       |
