...
export function useTaskNotifications() {
  ...
  useEffect(() => {
    ...
    const scheduleNotifications = async () => {
      ...
      // Bug 20 fix: Cancel existing task notifications before re-scheduling
      // to prevent duplicate notifications on every tasks update.
      await NotificationManager.cancelTaskNotifications();
